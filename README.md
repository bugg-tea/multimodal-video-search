...
Example :- uploaded a video having mountains somewhere or teacher explaining ohm's law, user can ask - "mountains" or "teacher explaining ohms" , our search engine will search that part in the video and return the timestamp containing that portion. (you can even see demo image in project-demo-image folder)
